...
//#region node_modules/highcharts-react-official/dist/highcharts-react.min.js
var require_highcharts_react_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(t, e) {
		...
		return function(t) {
			...
			Object.defineProperty(e, "__esModule", { value: !0 }), r.d(e, "HighchartsReact", function() {
				return d;
			});
			var p = r(1), l = r.n(p), y = "undefined" != typeof window ? p.useLayoutEffect : p.useEffect, d = Object(p.memo)(Object(p.forwardRef)(function(t, e) {
				...
				}, []), l.a.createElement("div", n({}, t.containerProps, { ref: r }));
			}));
			e.default = d;
		}, function(e, r) {
			e.exports = t;
